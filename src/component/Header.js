...
export default function Header(props) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      document.getElementById("sm-login-nonAuth").style.display =
        "inline-block";
      ...
      <header>
        ...
        <div className="navbar-custom">
          <div className="navbar-logo">
            <img src={"/falcon.jpeg"} id="logo-img" alt="..." />
          ...
          <div className="nav-collapse2">
            <Link to={"/carts"} onClick={unsetColor}>
              <button className="btn-cart mx-2">
                Cart <b id="no_cart">{noOfCard}</b>
              </button>
            </Link>

            <Link to={"SignIn"} onClick={unsetColor} id="SignIn-btn">
              <button className="btn-login  mx-2">Login</button>
            </Link>
            ...
            <div id="user-display">
              <div className="dropdown">
                ...
                >
                  <li className="dropdown-item user-op" onClick={logoutUser}>
                    Logout
                  </li>
                </ul>
              </div>
          ...
          <div className="small-screen-nav">
            ...
            <div id="sm-login-Auth">
              <div className="dropdown">
                <button
                  className="btn btn-login auth-sm-login-icon"
                  id="dropdownMenuLink"
                  data-bs-toggle="dropdown"
                  aria-expanded="false"
                >
