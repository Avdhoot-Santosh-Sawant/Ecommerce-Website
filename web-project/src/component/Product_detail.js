                ...
                <div>
                    <div className="container-custom my-4">
                        ...
                        <div className="row gx-4 my-3">
                            ...
                            <div className="col col-sm-6 my-4 my-lg-2">
                                ...
                                <div className="mx-5 my-3">
                                    <p>Price :- Rs. <span id="mrp">{product.price}</span></p>
                                    <p>Quantity: <span id="q">{product.quantity} {product.type === 'egg' ? 'PCs' : 'gms'}</span></p>
                                ...
                                <div className="product-action-btn mx-5">
                                    <button id="btn-atc" onClick={addToCart}>Add to cart</button>
                                </div>
