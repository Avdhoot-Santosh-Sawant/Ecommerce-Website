  ...
  return (
    <>
      <div className="col-12 col-sm-6 col-lg-4 col-xl-4 col-xxl-3">
        <div style={{ textDecoration: "none", color: "black" }} className="card">
          ...
          <p className="rate">
            MRP:₹<span className="price">{props.product.price}/{props.product.quantity}
              {props.product.type === "egg" ? " PCs" : " gms"}</span>
          </p>
