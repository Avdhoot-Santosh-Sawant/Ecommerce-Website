    ...
    <>
      <div className="container mt-4">
        ...
        <div id="category">
          ...
          <div id="c-chicken" onClick={() => { active('chicken') }}>
            <img src={"/images/home-img-chicken.png"} width='40%' alt=".." />
            <h6 className="nameP">Chicken</h6>
          </div>

          <div id="c-egg" onClick={() => { active('egg') }}>
            <img src={"/images/eggs.jpg"} width='40%' alt=".." />
      ...
      <div className='container my-4'>
        <div className="row justify-content-center gx-md-5 gx-3 gy-4">
          ...
          {
            filterdData().map((pro) => {
              return <Product key={pro.id} product={pro} AppStateHandle={props.AppStateHandle}  />
            })
          }
